...
canvas.width = 500 * devicePixelRatio; // 실제 너비를 픽셀 비율에 맞춰 설정
canvas.height = 400 * devicePixelRatio; // 실제 높이를 픽셀 비율에 맞춰 설정
...
// // 실제 해상도에 맞춰 캔버스 크기 조정
// function resizeCanvas() {
//   const displayWidth = canvas.offsetWidth;
//   const displayHeight = canvas.offsetHeight;

//   // 캔버스의 CSS 크기와 실제 픽셀 크기를 일치시키기
...
//setInterval(updateRoboTable, 5000);
setInterval(() => get_total_alert_Table("total_alert_table"), 1000);
setInterval(() => get_total_alert_Table("total_alert_table2"), 1000);
